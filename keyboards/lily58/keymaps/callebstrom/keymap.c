...
[_RAISE] = LAYOUT( \
  ...
  KC_LSFT, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, XXXXXXX,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, SE_QUOT, \
  KC_LCTRL, KC_LT, XXXXXXX, XXXXXXX, KC_VOLD, XXXXXXX,  ALGR(SE_LABK), _______,  KC_SCRL, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, SE_TILD, \
